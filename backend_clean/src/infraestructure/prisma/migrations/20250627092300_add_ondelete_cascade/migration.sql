...
-- DropForeignKey
ALTER TABLE "MovimentacaoEstoque" DROP CONSTRAINT "MovimentacaoEstoque_idPessoa_fkey";
...
-- AddForeignKey
ALTER TABLE "MovimentacaoEstoque" ADD CONSTRAINT "MovimentacaoEstoque_idPessoa_fkey" FOREIGN KEY ("idPessoa") REFERENCES "Pessoa"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "MovimentacaoEstoque" ADD CONSTRAINT "MovimentacaoEstoque_idLocalArmazenamentoDestino_fkey" FOREIGN KEY ("idLocalArmazenamentoDestino") REFERENCES "LocalArmazenamento"("id") ON DELETE CASCADE ON UPDATE CASCADE;
