...
export class ProdutoController{
    async create(req: Request, res:Response){
        const {nome,status,dataCadastro,precoVenda,precoCompra,descricao,quantidadeEstoque,idCategoria} = req.body;
        try{
            await createProduto.execute(nome,status,dataCadastro,precoVenda,precoCompra,descricao,quantidadeEstoque,idCategoria)
    ...
    async update(req: Request, res:Response){
        ...
        const { nome,status,dataCadastro,precoVenda,precoCompra,descricao,quantidadeEstoque,idCategoria} = req.body
        try{
            await updateProduto.execute(id, nome,status,dataCadastro,precoVenda,precoCompra,descricao,quantidadeEstoque,idCategoria)
